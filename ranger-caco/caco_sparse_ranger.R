...
ranger_mtr_sprs <- ranger_mtr %>% mutate(encoding = "sparse")
...
save(ranger_prof_sprs, ranger_time_sprs, ranger_mtr_sprs, file = "ranger-caco/sparse.RData")
